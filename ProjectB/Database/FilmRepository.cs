...
namespace JimFilmsTake2.Db
{
    public class FilmRepository
    {
        ...
        public static readonly string FILEPATH = @"/Users/isabellestienen/Documents/Project-B-Groep4/ProjectB/Database/db.json";
        ...
        public void FilmToevoegen()
        {
            ...
            if (antwoord == "Ja" || antwoord == "ja") {
                ...
                {
                    var nieuwfilm = new Film(filmtoevoegen, tijdfilm, datumfilm, genrefilm);
                    AddFilm(nieuwfilm);
                    UpdateData();
                    int Index2 = 1;
                    foreach (Film i in this._database.Films)
